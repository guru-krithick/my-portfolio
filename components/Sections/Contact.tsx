            ...
            <div className="space-y-8">
              <div className="text-center space-y-4">
                ...
                <motion.div
                  ...
                  className="flex flex-wrap justify-center gap-4 mt-6 text-gray-600"
                >
                    ...
                    <HoverCard>
                      <HoverCardTrigger asChild>
                        <a
                          ...
                          className="block"
                        >
                          <div className="group p-4 bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-xl hover:shadow-md transition-all duration-300">
              ...
              >
                ...
                <Button
                  variant="outline"
                  className="group text-gray-600 border-blue-200 hover:border-blue-300"
                  onClick={() => {
                ...
                >
                  <Download className="mr-2 h-4 w-4 text-gray-600 group-hover:animate-bounce" />
                  Resume
                </Button>
              </motion.div>
              ...
              <div className="flex justify-center">
                <div className="md:min-w-[350px] min-w-full sm:min-w-[300px]">
                  <div className="flex p-2 items-center border rounded-full justify-between border-gray-500">
                    <div className="flex gap-3 items-center">
                      <Link href="https://wa.me/9363041148">
                        <IoLogoWhatsapp className="text-blue-600 p-2 text-4xl bg-blue-200 rounded-full" />
                      </Link>
                      <h1 className="font-semibold lg:text-md text-sm text-gray-600">
                        +91 93630 41148
                      </h1>
                    </div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1 }}
                className="mt-8 bg-gradient-to-r from-blue-100 to-blue-50 rounded-2xl p-6 text-center"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-center space-x-2">
                    <Heart className="h-6 w-6 text-red-500 animate-pulse" />
                    <h3 className="text-xl font-semibold text-black">Support Open Source</h3>
                  </div>
